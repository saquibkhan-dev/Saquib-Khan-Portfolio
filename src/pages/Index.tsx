...
const SocialStrip = () => {
  const socials = [
    { label: "GitHub", href: "https://github.com/SAQUIBKHAN-DEV" },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/saquib-khan-dev/" },
    { label: "Instagram", href: "https://www.instagram.com/saquibkhan_dev/" },
    { label: "Email", href: "mailto:saquibkhanjava@gmail.com" },
  ];
  return (
    <motion.div
...
const MobileSocialStrip = () => {
  const socials = [
    { label: "Github", icon: Github, href: "https://github.com/saquibkhan-dev" },
    { label: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/saquib-khan-dev/" },
    { label: "Email", icon: Mail, href: "mailto:saquibkhanjava@gmail.com" },
  ];
  return (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
